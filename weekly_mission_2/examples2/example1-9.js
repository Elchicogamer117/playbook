...
class LaunchXStudent extends Developer{
      ...
      const cristianLaunchXDev = new LaunchXStudent("Cristian", "js", ["reactjs", "bootstrap", "nodejs"])
      console.log(cristianLaunchXDev)
      console.log(cristianLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija